progn<-function(x,y=NULL,filter="haar",n=5,r=5,pmax=5,lenmin=NULL,lenmax=NULL,alpha=0.1,fut=10){
...
gprint(NULL,dec$days,opt$m,dec$appr[1,],NULL,fitted(mdl),fut,y,pr,filter,r,pmax,alpha,opt$t)
return(pr)
}