progn3<-function(x,y=NULL,filter="haar",n=5,r=5,pmax=5,lenmin=NULL,lenmax=NULL,fut=10){
...
for (len in lenmin:lenmax)
{
  ...
  lt[len-lenmin+1,1:(r+1)]<-adj.R.sq(b,frm,r,pmax)# the optimal model (i.e., vector for len)
